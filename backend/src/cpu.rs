...
static OPC_LUT: [&[fn(&mut Emu)]; 0x100] = [
    ...
    &[],                                                               // 0xB7
    &[],                                                               // 0xB8
    &[abs_idx_y_low, abs_idx_high::<false>, abs_idx_fix, lda, decode], // 0xB9
    &[],                                                               // 0xBA
    &[],                                                               // 0xBB
    &[abs_idx_x_low, abs_idx_high::<false>, abs_idx_fix, ldy, decode], // 0xBC
    &[abs_idx_x_low, abs_idx_high::<false>, abs_idx_fix, lda, decode], // 0xBD
    &[abs_idx_y_low, abs_idx_high::<false>, abs_idx_fix, ldx, decode], // 0xBE
    &[],                                                               // 0xBF
    &[],                                                               // 0xC0
    &[],                                                               // 0xC1
    &[],                                                               // 0xC2
...
fn abs_idx_high<const W: bool>(emu: &mut Emu) {
    // The carry is stored in the high byte of `addr` by `abs_idx_(x|y)_low`.
